PyNote is a simple note-taking app built using Python and PyQt5. The app allows users to create, edit, and save notes, as well as track the number of characters in their notes in real-time.
